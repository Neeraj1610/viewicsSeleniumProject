...
public class MyntraRepository {
	...
	public final String loginToMyntraXpath = "//div/p[text()='Login to Myntra']";
	public final String itemSelectedSizeXpath = "//div[@class='itemComponents-base-size ']";
	...
	@FindBy(xpath = loginToMyntraXpath)
	public WebElement loginToMyntra;
	
	@FindBy(xpath = itemSelectedSizeXpath)
	public WebElement itemSelectedSize;
